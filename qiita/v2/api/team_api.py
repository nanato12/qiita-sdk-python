...
class TeamApi:
    ...
    def add_group_members(
        self,
        url_name: Annotated[StrictStr, Field(description="グループのチーム上での一意な名前")],
        add_group_member_request: Optional[AddGroupMemberRequest] = None,
        ...
        :param url_name: グループのチーム上での一意な名前 (required)
        :type url_name: str
        :param add_group_member_request:
    ...
    def _add_group_members_serialize(
        ...
        if url_name is not None:
            _path_params['url_name'] = url_name
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/groups/{url_name}/members',
    ...
    @validate_call
    def create_imported_comment(
        self,
        item_id: Annotated[StrictStr, Field(description="Article ID")],
        create_imported_comment_request: Optional[CreateImportedCommentRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param item_id: Article ID (required)
        :type item_id: str
        :param create_imported_comment_request:
        :type create_imported_comment_request: CreateImportedCommentRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_imported_comment_serialize(
            item_id=item_id,
            create_imported_comment_request=create_imported_comment_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def create_imported_comment_with_http_info(
        self,
        item_id: Annotated[StrictStr, Field(description="Article ID")],
        create_imported_comment_request: Optional[CreateImportedCommentRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def create_imported_comment_without_preload_content(
        self,
        item_id: Annotated[StrictStr, Field(description="Article ID")],
        create_imported_comment_request: Optional[CreateImportedCommentRequest] = None,
        _request_timeout: Union[
    ...
    def _create_imported_comment_serialize(
        self,
        item_id,
        create_imported_comment_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if create_imported_comment_request is not None:
            _body_params = create_imported_comment_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/items/{item_id}/imported_comments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_group_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/groups/{url_name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_group_members(
        self,
        url_name: Annotated[StrictStr, Field(description="グループのチーム上での一意な名前")],
        delete_group_member_request: Optional[DeleteGroupMemberRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param url_name: グループのチーム上での一意な名前 (required)
        :type url_name: str
        :param delete_group_member_request:
        :type delete_group_member_request: DeleteGroupMemberRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._delete_group_members_serialize(
            url_name=url_name,
    ...
    @validate_call
    def delete_group_members_with_http_info(
        self,
        url_name: Annotated[StrictStr, Field(description="グループのチーム上での一意な名前")],
        delete_group_member_request: Optional[DeleteGroupMemberRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def delete_group_members_without_preload_content(
        self,
        url_name: Annotated[StrictStr, Field(description="グループのチーム上での一意な名前")],
        delete_group_member_request: Optional[DeleteGroupMemberRequest] = None,
        _request_timeout: Union[
    ...
    def _delete_group_members_serialize(
        self,
        url_name,
        ...
        # process the form parameters
        # process the body parameter
        if delete_group_member_request is not None:
            _body_params = delete_group_member_request
    ...
    @validate_call
    def get_group_member_with_http_info(
        self,
        url_name: Annotated[StrictStr, Field(description="グループのチーム上での一意な名前")],
        user_id: Annotated[StrictStr, Field(description="ユーザーID")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_group_member_without_preload_content(
        self,
        url_name: Annotated[StrictStr, Field(description="グループのチーム上での一意な名前")],
        user_id: Annotated[StrictStr, Field(description="ユーザーID")],
        _request_timeout: Union[
    ...
    def _get_group_member_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/groups/{url_name}/members/{user_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_oauth_team_authorize(
        ...
        _param = self._get_oauth_team_authorize_serialize(
            client_id=client_id,
            scope=scope,
            state=state,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_oauth_team_authorize_with_http_info(
        self,
        client_id: Annotated[str, Field(min_length=40, strict=True, max_length=40, description="登録されたAPIクライアントを特定するためのIDです。40桁の16進数で表現されます。")],
        scope: Annotated[StrictStr, Field(description="アプリケーションが利用するスコープをスペース区切りで指定できます。")],
        state: Annotated[StrictStr, Field(description="CSRF対策のため、認可後にリダイレクトするURLのクエリに含まれる値を指定できます。")],
    ...
    @validate_call
    def get_oauth_team_authorize_without_preload_content(
        self,
        client_id: Annotated[str, Field(min_length=40, strict=True, max_length=40, description="登録されたAPIクライアントを特定するためのIDです。40桁の16進数で表現されます。")],
        scope: Annotated[StrictStr, Field(description="アプリケーションが利用するスコープをスペース区切りで指定できます。")],
        state: Annotated[StrictStr, Field(description="CSRF対策のため、認可後にリダイレクトするURLのクエリに含まれる値を指定できます。")],
    ...
    def _get_oauth_team_authorize_serialize(
        self,
        client_id,
        scope,
        state,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/oauth/team_authorize',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
